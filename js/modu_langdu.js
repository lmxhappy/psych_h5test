...
//                        alert('object');
    ...
    modu_sentences = ['放暑假了,小丽穿上漂亮的花棉袄去姥姥家玩','牛顿发明了电灯','十月一号是国庆节','香蕉和菠菜都是水果','中国国旗是五星红旗','中国和美国是相邻的','课本大多数是纸质的','小鸡用四条腿在地上跑','金鱼摇摆尾巴在水里游','山羊最喜欢吃新鲜的竹子','天上的大雁排成了人字形','丁丁正在用小刀削自动铅笔','夏天田地里很多青蛙在叫','早晨,太阳从西边的群山间升起','春节是个合家团圆的日子','这河水很脏,能看清河底的石块','夜晚,湖面倒映着月亮的影子','他今天生日,妈妈给他买了块月饼','乐乐的小狗看到陌生人会狂叫','乌云密布,妈妈准备把被子拿出去晒晒','打雷了,不久就响起哗啦啦的雨点声','大家一边吃着元宵,一边欣赏着天上的月牙','端午节时,超市开始卖各式各样的粽子','大家都说新发的校服好看,女生裙子的颜色漂亮'];
...
//        收集显示和答题结果
        collector.push2Modu(modu_content, parseInt(result), parseInt(start_time), parseInt(finish_time));
        console.log(collector);
        console.log('默读');
